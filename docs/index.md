...
features:
  ...
  - icon: ⚡
    title: Live TypeSafe Jev Model
    details: Direct single forward-pass integration via Vercel AI Gateway (typesafe-ai/jev) with Choice, Boolean, and Score primitives.
  - icon: 🎥
